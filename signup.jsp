...
<head>
    ...
    <!--external css-->
    <link href="assets/fontawesome-free-5.13.0-web/css/font-awesome.css" rel="stylesheet" />
        ...
        <div class="navbar-header">
            ...
            <div class="horizontal-menu navbar-collapse collapse ">
                <ul class="nav navbar-nav">
                    ...
                    <li><a href="#">所有书评</a></li>
                 <!--   <li><a href="#">书圈</a></li>-->
                    <li class="active"><a href="login.jsp" class="active">登录/注册</a></li>
                </ul>
        ...
        <section class="wrapper">
            ...
            <div class="row">
                ...
                <div class="col-lg-5">
                    ...
                    <br/><br/>
                    <i>"I love not Man the less, but Nature more.
                        From these our interviews, in which I steal.
                        From all I may be, or have been before.</i>
                    <i>To mingle with the Universe, and feel
                        What I can ne'er express, yet cannot all conceal."</i><br/>
                    <p>                    --George Gordon Byron:Childe Harold's Pilgrimage:"Apostrophe to the Ocean"</p>
                </div>
                <div class="col-lg-1"></div>
                <div class="col-lg-5">
                    <section class="panel">
                            ...
                            <div class=" form">
                                <form class="cmxform form-horizontal tasi-form" id="commentForm" method="get" action="">
                                    <div class="form-group ">
                                        <label for="username" class="control-label col-lg-3 col-lg-offset-2">用户名</label>
                                        <div class="col-lg-6">
                                            <input class=" form-control" id="username" name="username" minlength="3" type="text" required />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group ">
                                        <label for="confirm_password" class="control-label col-lg-3 col-lg-offset-2">确认密码</label>
                                        <div class="col-lg-6">
                                            <input class="form-control " id="confirm_password" name="confirm_password"  type="password" required></input>
                                        </div>
                                    </div>
                                    <div class="form-group ">
